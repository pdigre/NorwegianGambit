...
//		  VALUE_NONE      = 32002,
		...
		int[][] pval={S(198,258), S(817,846), S(836,857), S(1270,1278), S(2521,2558), S(9999,9999)};
		// psqtab.h
    	int[][][] psqt = new int[][][]{ 
    			  { // Pawn
    		   ...
    		   print(psqt[0],pval[0],"Pawn");
    		   print(psqt[1],pval[1],"Knight");
    		   print(psqt[2],pval[2],"Bishop");
    		   print(psqt[3],pval[3],"Rook");
    		   print(psqt[4],pval[4],"Queen");
    		   print(psqt[5],pval[5],"King");
    }

	private void print(int[][] map,int[] pval,String txt) {
		System.out.println("Piece: "+txt + " MidGame:"+pval[0]+ " EndGame:"+pval[1]);
