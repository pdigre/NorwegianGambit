...
Zobrist ^ bit1
    ...
    final public static int set(long zobrist,int depth, int type, int md, int score, long key2) {
		int i=(int)(zobrist&TranspositionTable.TTMASK);
    ...
    final public static int set(long zobrist,int depth, long count, long key2) {
		int i=(int)(zobrist&TranspositionTable.TTMASK);
		long s=count<<8;
		hash[i]=zobrist^key2;
		validate[i]=key2;
